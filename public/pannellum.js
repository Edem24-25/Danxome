  ...
  function Ba(s, l) {
    ...
    function pa() {
      ...
      Sa ||
        ...
        b.mouseZoom &&
          (J.addEventListener("mousewheel", U, !1), J.addEventListener("DOMMouseScroll", U, !1)),
    ...
    function ua(a) {
      if (ha && H) {
        ...
        a = Q(a);
        var c =
          (((180 * (Math.atan((xa / n) * 2 - 1) - Math.atan((a.x / n) * 2 - 1))) / Math.PI) *
            b.hfov) /
            90 +
          Oa;
        ...
        n =
          (((180 * (Math.atan((a.y / f) * 2 - 1) - Math.atan((ya / f) * 2 - 1))) / Math.PI) * n) /
            90 +
          Pa;
    ...
    function Fa() {
      ...
      if (H) {
        ...
        a =
          ((2 * Math.atan(Math.tan((b.hfov / 180) * Math.PI * 0.5) / (f.width / f.height))) /
            Math.PI) *
          180;
        f = b.minPitch + a / 2;
        n = b.maxPitch - a / 2;
      ...
      if (a.video) {
        ...
        (a.sceneId &&
          ((f.onclick = f.ontouchend =
            function () {
              f.clicked ||
                ((f.clicked = !0), y(a.sceneId, a.targetPitch, a.targetYaw, a.targetHfov));
              return !1;
            }),
          (f.className += " pnlm-pointer"),
          (c.className += " pnlm-pointer")),
    ...
    function Ca(a) {
      ...
      if ((90 >= a.yaw && -90 < a.yaw && 0 >= h) || ((90 < a.yaw || -90 >= a.yaw) && 0 >= h))
        ...
        p =
          "translate(" + f[0] + "px, " + f[1] + "px) translateZ(9999px) rotate(" + b.roll + "deg)";
